  ...
  return (
    <div className="min-h-screen bg-blue-50 dark:bg-gray-900">
      <div className="container mx-auto p-4 sm:p-6 md:p-8 text-center">
        <motion.h1 
          className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 glass-effect p-4 rounded-lg"
        ...
        <p className="text-base sm:text-lg md:text-xl mb-6 glass-effect p-4 rounded-lg">
          A comprehensive web-based platform to monitor and manage system performance and infrastructure.
        </p>
        <Link 
          to="/dashboard" 
          className="bg-blue-600 dark:bg-blue-800 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full hover:bg-blue-700 transition"
        >
          Explore the Dashboard
        </Link>

        <section className="my-8 sm:my-10 md:my-12">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6">Key Features</h2>
        ...
        <section className="my-8 sm:my-10 md:my-12">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6">About Us</h2>
          <p className="glass-effect p-4 rounded-lg text-base sm:text-lg md:text-xl">
        ...
        <div className="flex flex-col items-center justify-center min-h-[40vh] sm:min-h-[50vh] md:min-h-[60vh]">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-blue-700 dark:text-blue-300">Welcome to the System Monitoring Dashboard</h2>
          ...
          <a
            href="/dashboard"
            className="px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition"
          >
            Go to Dashboard
          </a>
        </div>
